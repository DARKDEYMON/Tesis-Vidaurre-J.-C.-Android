...
public class ListItemReqMaterialActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_item_req_material);
        start();
    }
    public void start(){
    ...
    public void itemClick(AdapterView<?> parent, int position){
        ...
        Intent i = new Intent(ListItemReqMaterialActivity.this,SendMaterialActivity.class);
