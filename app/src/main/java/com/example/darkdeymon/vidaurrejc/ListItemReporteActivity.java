...
public class ListItemReporteActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        try {
            ...
            mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent i = new Intent(ListItemReporteActivity.this,SendItemActivity.class);
