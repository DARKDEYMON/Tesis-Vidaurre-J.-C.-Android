...
import com.example.darkdeymon.vidaurrejc.AsyncTasks.loginRest;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void login(String username, String password){
        loginRest l = new loginRest(username,password,this);
        l.execute();
        try {
            Log.e("da",l.get().toString());
            if(l.get()==true){
                Log.e("ejecutar","otra accion");
                Intent intent = new Intent(LoginActivity.this,seleccionar.class);
